...
$search  = array('index','Login','Exit','ChangePassword','Jobs','load_jobs','Websites','Categories','JobTypes');
$replace = array('jobs','login','exit','change_password','jobs','load_jobs','websites','categories','job_types');
